            ...
            <div id="mid">
                <div>
                    ...
                    <h3 style="font-weight: 900 ; font-size: 1cm" class="text-right pr-3">
                        فاتورة مبيعات : {{ $all['Bill']->online == null ? 'نقدا' : 'شبكة' }} <br>
                ...
                <b><b>
                        ...
                        <div class="info">
                            <p style="font-weight: 900 ; font-size: 1.2cm" class="text-right  text-bold">
                                ...
                                الضريبة : 15% <br>
                                قيمة الضريبة : {{ number_format($all['Bill']->total * 0.15, 2) }}
                                ريال
                                <br>
                                السعر قبل الضريبة :
                                {{ $all['Bill']->total - number_format($all['Bill']->total * 0.15, 2) }}
                                ريال
                                <br>
                        ...
                        <div id="mid">
                            <div class="info">
                                ...
                                <p tyle="font-weight: 900">السعر شامل الضريبة </h3>
